<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body onLoad="test();">
    	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <a class="navbar-brand" href="loggedIn.jsp" style="color:#f25d22; font-family: Georgia, Serif; font-weight: bold; font-size: 25px; width: 28%">James' LA Restaurants</a>
		...
		<% 
				String stringRat = (String)pageContext.getAttribute("rating");
				double rat = Double.parseDouble(stringRat);
				String temp="";
		...
		<hr style="margin: 20px 75px;">
		 ...
		 <div class="media">
			...
			<div class="media-body" style="font-size: large; line-height: 50px; margin-top: 5px;">
				...
				<span style="color: black; font-weight: 900;"> Rating:     </span>  <%out.print(request.getAttribute("starRating")); %> <br>
			</div>
		</div>
